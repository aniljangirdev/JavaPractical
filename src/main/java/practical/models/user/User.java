 ...
 *     <ul>
 *         <li>{@link practical.services.UserService} provides the business logic for the user.</li>
 *         <li>{@link UserRepository} JPA for database calls. </li>
 *         <li>{@link practical.models.response.UserResponse} class for what we want to give to the user. </li>
 *         <li>{@link practical.models.request.UserRequest} the request we need from the user.</li>
 *     </ul>
 * </p>
 *
 * @see practical.services.UserService
 * @see UserRepository
 * @see practical.models.response.UserResponse
 * @see practical.models.request.UserRequest
 */
@Getter
@Setter
@Builder
