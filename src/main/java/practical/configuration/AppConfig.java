package practical.configuration;
...
import static practical.util.Utils.combineArrays;
 ...
 * </p>
 * @see practical.models.user.Role User Role
 */
@Configuration
@EnableWebSecurity
...
public class AppConfig {
    private static final String[] ALLOWED_ALL = {"/css/**", "/images/**"
            , "/script/**", "/", "fragments/**", "/about", "/access-denied", "/error-page", "/v3/api-docs/**", "/swagger-ui/**", "/hello"};
